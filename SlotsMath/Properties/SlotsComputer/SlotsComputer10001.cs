...
namespace SlotsMath.Properties.SlotsComputer
{
    public class SlotsComputer10001:SlotsComputer
    {
        ...
        public SlotsComputer10001(Dictionary<string, DataTable> dataTableDictionary, double bet, string logName = "1001.txt", int rowsCount = 3, int columnsCount = 5, bool isWithLine = true) : base(dataTableDictionary, bet, logName, rowsCount, columnsCount, isWithLine)
        {
